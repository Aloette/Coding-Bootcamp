<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="org.afdemp.bootcamp.sofos.dao.*, org.afdemp.bootcamp.sofos.domain.*" %>
...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<% String am = request.getParameter("studentam");
			...
			sdao.open();
			student = sdao.findStudentByAM(am);
			sdao.close();
			if(student.getAm()!= null){%>
			<tr>
				<td><%=student.getAm()%></td>
			...
			<%}else{ %>
			<tr>
				<td colspan="3" align="center">Δεν υπάρχει μαθητής με ΑΜ <%=am%></td>
			</tr>
			<%}%>
			</tbody>
		</table>
